...
* [0/2] Use Twitter Bootstrap fixed width layout in our Rails application
  ...
  2. [ ] Compare our application at http://localhost:3000 with http://twitter.github.io/bootstrap/examples/starter-template.html.
     ...
     went wrong.
* [3/4] Setting up Twitter Bootstrap with the [[https://github.com/thomas-mcdonald/bootstrap-sass/blob/master/README.md#bootstrap-for-sass][bootstrap-sass]] Gem
  ...
  3. [X] Create a new [[file:../app/assets/stylesheets/application.css.scss][app/assets/stylesheets/application.css.scss]] file
     ...
     #+END_SRC
  4. [ ] Import bootstrap javascript file:../app/assets/javascripts/application.js
     #+BEGIN_SRC js
       //= require jquery
       //= require jquery_ujs
       //= require turbolinks
