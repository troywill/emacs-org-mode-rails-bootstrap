...
* [0/4] Incorporate [[http://twitter.github.io/bootstrap/][Twitter Bootstrap]]'s CSS style sheets and JavaScript scripts.
  ...
  1. [ ] Download the Zipfile from Twitter Bootstap website from your web browser or web client.
     #+BEGIN_SRC sh :tangle bin/fetch-bootstap-zip.sh :shebang #!/bin/sh
...
* [0/2] Use Twitter Bootstap's layout in our application instead of the default Rails layout

  1. [ ] Copy starter-template.html.erb to 
     file:app/views/layouts/starter-template.html.erb
